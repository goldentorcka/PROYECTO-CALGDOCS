    ...
    return (
        <>
            <form id="formatoForm" action="" onSubmit={sendForm}>
                ...
                <input type="text" id="nom_formato" value={nomFormato} onChange={(e) => setNomFormato(e.target.value)} />
                <br />
                <label htmlFor="cod_formato">Código del Formato</label>
                <input type="text" id="cod_formato" value={codFormato} onChange={(e) => setCodFormato(e.target.value)} />
                <br />
                <label htmlFor="ver_formato">Versión del Formato</label>
                <input type="text" id="ver_formato" value={verFormato} onChange={(e) => setVerFormato(e.target.value)} />
                <br />
                <label htmlFor="est_formato">Estado del Formato</label>
                <input type="text" id="est_formato" value={estFormato} onChange={(e) => setEstFormato(e.target.value)} />
                <br />
                <label htmlFor="id_responsable">ID Responsable</label>
                <input type="text" id="id_responsable" value={idResponsable} onChange={(e) => setIdResponsable(e.target.value)} />
                <br />
                {/* Aquí debe ir la lógica para subir archivos si es necesario */}
                <label htmlFor="archivo">Archivo</label>
                <input type="file" id="archivo" onChange={(e) => setArchivo(e.target.files[0])} />
                <br />
                <label htmlFor="nom_magnetico">Nombre Magnético</label>
                <input type="text" id="nom_magnetico" value={nomMagnetico} onChange={(e) => setNomMagnetico(e.target.value)} />
                <br />
                <label htmlFor="fec_actualizacion">Fecha de Actualización</label>
                <input type="date" id="fec_actualizacion" value={fecActualizacion} onChange={(e) => setFecActualizacion(e.target.value)} />
                <br />
                <label htmlFor="id_procedimiento">ID Procedimiento</label>
                <input type="text" id="id_procedimiento" value={idProcedimiento} onChange={(e) => setIdProcedimiento(e.target.value)} />
                <br />
                <label htmlFor="id_unidad">ID Unidad</label>
                <input type="text" id="id_unidad" value={idUnidad} onChange={(e) => setIdUnidad(e.target.value)} />
                <br />

                <input type="submit" id="boton" value={buttonForm} className="btn btn-primary" />
            </form>
        </>
    );
}
